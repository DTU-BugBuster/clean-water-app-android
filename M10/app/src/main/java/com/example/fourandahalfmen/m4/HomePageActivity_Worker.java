...
public class HomePageActivity_Worker extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewWaterAvailability.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                Intent i = new Intent(HomePageActivity_Worker.this, ViewWaterAvailabilityActivity.class);
                startActivity(i);
            }
        });
    ...
    private void alertMessage(String title, String body) {
        AlertDialog.Builder dialog2 = new AlertDialog.Builder(HomePageActivity_Worker.this);
