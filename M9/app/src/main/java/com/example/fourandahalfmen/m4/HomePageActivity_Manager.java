...
public class HomePageActivity_Manager extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        logout.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent i = new Intent(HomePageActivity_Manager.this, WelcomeActivity.class);
                startActivity(i);
            }
        });
...
//        });
        ...
        viewReports.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                Intent i = new Intent(HomePageActivity_Manager.this, ListViewAvailabilityActivity.class);
                startActivity(i);
            }
        });
        ...
        viewWaterAvailability.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                Intent i = new Intent(HomePageActivity_Manager.this, ViewWaterAvailabilityActivity.class);
                startActivity(i);
            }
        });
...
//                Log.d("reflocation", post.password);
    ...
    private void alertMessage(String title, String body) {
        AlertDialog.Builder dialog2 = new AlertDialog.Builder(HomePageActivity_Manager.this);
